...
#define TYPE_RISCV_CPU_THEAD_C910V      RISCV_CPU_TYPE_NAME("thead-c910v")
#define TYPE_RISCV_CPU_THEAD_C910V2     RISCV_CPU_TYPE_NAME("thead-c910v2")
#define TYPE_RISCV_CPU_THEAD_C920       RISCV_CPU_TYPE_NAME("thead-c920")
#define TYPE_RISCV_CPU_THEAD_C920V2     RISCV_CPU_TYPE_NAME("thead-c920v2")
#define TYPE_RISCV_CPU_THEAD_C920V3     RISCV_CPU_TYPE_NAME("thead-c920v3")
...
#define TYPE_RISCV_CPU_SPACEMIT_X60     RISCV_CPU_TYPE_NAME("spacemit-x60")
