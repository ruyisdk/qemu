...
static const TypeInfo riscv_cpu_type_infos[] = {
    ...
    /*
     * The vendor xuantie-qemu-9.0 tree enables legacy XTheadVector for
     * C910V.  This tree does not implement that extension yet, so keep the
     * model as a C910-derived entry point until XTheadVector is ported.
     */
    DEFINE_RISCV_CPU(TYPE_RISCV_CPU_THEAD_C910V, TYPE_RISCV_CPU_THEAD_C910,
    ),

    DEFINE_RISCV_CPU(TYPE_RISCV_CPU_THEAD_C910V2, TYPE_RISCV_VENDOR_CPU,
        .misa_mxl_max = MXL_RV64,
        .misa_ext = RVG | RVC | RVS | RVU,
        .priv_spec = PRIV_VERSION_1_12_0,
        ...
        .cfg.ext_svinval = true,
        .cfg.ext_svnapot = true,
        .cfg.pmu_mask = MAKE_64BIT_MASK(3, RV_MAX_MHPMCOUNTERS - 3),
        .cfg.mvendorid = THEAD_VENDOR_ID,
        .cfg.marchid = 0x8d0c3000,
        .cfg.max_satp_mode = VM_1_10_SV48,
#ifndef CONFIG_USER_ONLY
        .custom_csrs = th_csr_list,
#endif
    ...
    DEFINE_RISCV_CPU(TYPE_RISCV_CPU_SPACEMIT_X60, TYPE_RISCV_VENDOR_CPU,
        .misa_mxl_max = MXL_RV64,
        .misa_ext = RVG | RVC | RVB | RVS | RVU | RVV,
        .priv_spec = PRIV_VERSION_1_12_0,
        .vext_spec = VEXT_VERSION_1_00_0,
        ...
        .cfg.mvendorid = SPACEMIT_VENDOR_ID,
        .cfg.marchid = SPACEMIT_X60_MARCHID,
        .cfg.mimpid = SPACEMIT_X60_MIMPID,
